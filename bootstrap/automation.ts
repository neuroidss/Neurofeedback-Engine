...
const EVOLVE_PROTOCOL_SAFELY: ToolCreatorPayload = {
    ...
    implementationCode: `
        ...
        const newCode = await runtime.ai.generateText(mutationPrompt, "You are a React/JS expert. Output ONLY valid JavaScript/JSX code. DO NOT wrap it in markdown backticks.");
